...
gcc test/extparsertest.c src/nimiq_utils.c src/base32.c src/blake2b.c test/test_utils.c -o obj/extparsertest -I src/ -I test/ -D TEST
./obj/extparsertest test/extendedTx.hex
